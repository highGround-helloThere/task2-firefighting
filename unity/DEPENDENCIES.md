...
| Android Build Support | 与 Unity `2022.3.76f1` 同版本，包含 Android SDK、NDK 和 OpenJDK |
...
- 全组统一使用 Unity `2022.3.76f1`，并安装同版本 Android Build Support、Android SDK & NDK Tools、OpenJDK。
- 安装与 Unity 2022.3.76f1 匹配的 Shader Graph `14.0.12`。
